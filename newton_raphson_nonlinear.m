function [x,f,ea,iter] = newton_raphson_nonlinear(func,x0,es,maxit,varargin)
% newton_raphson_nonlinear: Newton-Raphson root zeroes nonlinear systems
% [x,f,ea,iter] = newton_raphson_nonlinear(func,x0,es,maxit,p1,p2,...):
