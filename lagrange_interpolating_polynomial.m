function yint = lagrange_interpolating_polynomial(x,y,xx)
% lagrange_interpolating_polynomial: Lagrange interpolating polynomial
% yint = lagrange_interpolating_polynomial(x,y,xx): Uses an (n - 1)-order
